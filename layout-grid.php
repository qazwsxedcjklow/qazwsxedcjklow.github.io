			...
			<div id="content" class="site-content" role="main">
				...
				<?php
					if ( isset( $_GET['first_full'] ) )
					{
						...
						{
							$impose_grid_layout_1st_full = 'Yes';
						}
						else
						{
							$impose_grid_layout_1st_full = 'No';
						}
					}
					else
					{
				...
				<div class="media-grid-wrap">
					<div class="masonry blog-masonry blog-stream <?php if ( $impose_grid_layout_1st_full == 'Yes' ) { echo 'first-full'; } ?>" data-layout="<?php echo esc_attr( $impose_grid_layout_type ); ?>" data-mobile-item-width="220" data-item-width="<?php echo esc_attr( $impose_grid_layout_post_width ); ?>">
						<?php
							if ( have_posts() ) :
								while ( have_posts() ) : the_post();
								
									if ( $impose_grid_layout_1st_full == 'Yes' )
									{
										?>
													...
													if ( has_post_thumbnail() )
													{
														?>
															<div class="featured-image">
																<a href="<?php the_permalink(); ?>">
																	<?php
																		if ( $impose_grid_layout_type == 'masonry' )
																		{
																			the_post_thumbnail( 'impose_image_size_3' );
																		}
																		else
																		{
																			the_post_thumbnail( 'impose_image_size_4' );
																		}
																	?>
																</a>
															</div>
